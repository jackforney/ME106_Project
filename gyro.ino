...
void setup()
{
  ...
  Serial.println("Starting in at 30000");
...
void loop()
{
  ...
  if ((mpuIntStatus & 0x10) || fifoCount == 1024) {
    ...
    Serial.print("\t");
    Serial.println(ypr[2] * 180 / M_PI + 15);
#endif
  ...
  */
  ...
  pos = ((ypr[2] * 180 / M_PI + 15) + 79); // servo goes from 0 to 180 so we are telling it to go to 79 for level
  servox.write(pos);
  while (pos < -3 )
  {
    pos = pos + 0.5;
